	...
	const projects = [
		{
			...
			description: "Real-time transaction tracking and analytics.",
		},
		{
		...
		},
		{
			...
			description: "Scalable analytics dashboard for SaaS applications.",
		},
	];

	return (
		<section id="projects" className="py-24">
			<h2 className="text-4xl font-semibold mb-12">Stuff I have built</h2>
